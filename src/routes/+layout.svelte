	...
	<svelte:fragment slot="header">
		...
		<AppBar>
			<svelte:fragment slot="lead">
				<div class="flex">
					<button class="lg:hidden btn px-2" on:click={drawerOpen}>
						<svg class="fill-token w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
							><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg
						>
					</button>
					<button class="btn px-3">
						<a href="/">
							<svg class="fill-token w-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
								<path
			...
			<svelte:fragment slot="trail">
				<button type="button" class="btn mx-0 px-0">
					<a href="https://github.com/martin-sebastian" target="_blank">
						<svg class="fill-token w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
							><path
				...
				<button type="button" class="btn mx-0 px-0">
					<a href="https://twitter.com/martisebastian" target="_blank">
						<svg class="fill-token w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"
							><path
